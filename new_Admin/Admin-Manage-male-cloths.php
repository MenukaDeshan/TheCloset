  ...
  <?php
        {
          ...
          while ($row = mysqli_fetch_assoc($select_cloths)) {
            ...
            echo "<td>$Metirial</td>";
            echo "<td>$Image</td>";
            echo "<td><a href='Admin-Male-Update.php?edit={$id}'>Update</a><br>
                      <a href='Admin-Manage-male-cloths.php?delete={$id}'>Delete</a></td>";
            echo "</tr>";
          }
        }
        ?>
      <?php 
        ...
        if(isset($_GET['delete'])){
            $id = $_GET['delete'];
            $query = "delete from mclothes where id = {$id}";
