              ...
              <div class="container">
                <div class="row">
                  <div class="col-md-9 col-lg-8 mx-auto">
                    <h3 class="login-heading mb-4">Add Female Cloths</h3>
...
if (isset($_POST['submit'])) {    
   ...
   move_uploaded_file($img_temp, "../img/$img");
        ...
        if ($ClothesName==""||$Discription==""||$Price==""||$Size==""||$Metirial==""||$img==""||$Qty=="")
        {
            $msg = "Clothes Details fields cant be empty.";
            echo "<script type='text/javascript'>alert('$msg');</script>";
            header("refresh:10; url=Admin-female-Add.php");
        }
    else
    {
    
	$sql = "INSERT INTO fclothes ". "(name,discription,price,size,metirial,file,qty) ". "VALUES('$ClothesName','$Discription','$Price','$Size','$Metirial','$img','$Qty')";
	...
	$results = mysqli_query($conn, $sql);
        ...
        echo "<script type='text/javascript'>alert('$msg');</script>";
            header("refresh:1; url=Admin-female-Add.php");
			}
   }}  
?>